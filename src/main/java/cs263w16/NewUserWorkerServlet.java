...
import cs263w16.datasources.PutFailedException;
import cs263w16.datasources.RedefinitionException;
...
public class NewUserWorkerServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        if (email != null && firstname != null && lastname != null && username != null) {
            ...
            } catch (RedefinitionException rde) {
                resp.setStatus(409);

            } catch (PutFailedException pfe) {
                resp.setStatus(500);
            }
        }
